  ...
  return (
    <div className="grid grid-cols-3 grid-rows-3 items-center justify-items-center gap-3 ">
      ...
      <svg
        ...
        className="z-6 floating3  lg:scale-[1.75] lg:self-center self-start"
      >
        <path
      ...
      <div> </div>
      <img className="z-4 scale-[2.75] lg:scale-[2]" src="/images/about/GlacierNearHuarazPeru.png" alt="Picture of Author in Perú" />
      <svg
        width="65"
        height="66"
        viewBox="0 0 65 66"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="z-5 scale-110 lg:scale-[2] floating"
      >
        <path
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="z-5 scale-[1.5] justify-self-end self-start floating2 lg:scale-[40]"
      >
        <path
