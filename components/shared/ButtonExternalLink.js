const ButtonExternalLink = ({ buttonText, solidColour, destinationLink }) => { 
  return (
    <a
      ...
      target="_blank"
      className={`flex flex-row justify-center items-center px-2 py-4 gap-2 w-40 h-14 border-2 sm:w-44 sm:h-18md:gap-1 md:w-52 md:h-26 md:py-1 md:px-2 xl:w-64 xl:h-16 xl:py-10 hover:cursor-pointer ${
        solidColour
