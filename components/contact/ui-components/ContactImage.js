const ContactImage = () => {
    return (
      <div className="w-full flex flex-col justify-center items-center relative scale-95 md:w-1/2">
        <img className="z-4 absolute top-0 left-0 right-0 bottom-0 m-auto scale-95" src="/images/contact/football-img.png" />
        <svg
          width="479"
          height="497"
          viewBox="0 0 479 497"
