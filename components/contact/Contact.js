...
const Contact = () => {
    return(
        <div id="contact" className="w-full h-screen bg-rich_black flex flex-col-reverse  justify-center items-start gap-3 px-5 py-10 lg:flex-row lg:justify-evenly xl:px-48 xl:py-32">
