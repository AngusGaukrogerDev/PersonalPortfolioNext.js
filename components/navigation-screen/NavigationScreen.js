...
const NavigationScreen = ({onSelectItem}) => {
  return (
    <div className="fixed w-full h-screen bg-rich_black text-anti-flash_white flex flex-col justify-center items-start gap-10 sm:gap-2 sm:py-3 px-5 z-[98]  xl:px-48 xl:py-32">
